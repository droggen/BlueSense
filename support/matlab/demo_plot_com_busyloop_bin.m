...
while 1
    % Read one byte
    [dataread,dataredn]=fread(ser,ser.InputBufferSize);
    
    it=it+1;
    t = toc;
    totread=totread+dataredn;
    fprintf(1,'Iteration %u: read %u. Tot red %u in %f. Sps: %f\n',it,dataredn,totread,t,totread/t);
